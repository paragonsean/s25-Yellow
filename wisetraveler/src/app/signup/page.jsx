  ...
  return (
    <div>
      ...
      <form className={styles.form}>
        ...
        <label className={styles.label}>
          Username
          <input type="text" name="text" placeholder="Enter Username" className={styles.input} required/>
        </label>
        <label className={styles.label}>
           Set Password
        ...
        <label className={styles.label}>
           Confirm Password
          <input type="password" name="password" placeholder=" Confirm Password" className={styles.input} required/>
        </label>
